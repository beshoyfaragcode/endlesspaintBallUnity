...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=stuff&box=110.297998,60.287741,109.790520,60.036215
...
-----------
  ...
  * stuff Height Map (ASTER 30m).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * stuff Height Map (SRTM30 Plus).png
...
These heightmaps were adjusted such that 277m (actual) is equal to 40m in
